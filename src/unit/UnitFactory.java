...
public class UnitFactory {
	...
	public UnitFactory() {
		...
		UnitProducer star = new StarProducer(this);
		UnitProducer compare = new CompareProducer(this);
		UnitProducer logical = new LogicalProducer(this);
		UnitProducer not = new NotProducer(this);
		UnitProducer plus = new PlusProducer(this);
		UnitProducer minus = new MinusProducer(this);
		...
		minus.setNext(comment);
		
		//double chars
		comment.setNext(lComment);
		lComment.setNext(rComment);
		rComment.setNext(compare);
		compare.setNext(logical);
		logical.setNext(charP);
